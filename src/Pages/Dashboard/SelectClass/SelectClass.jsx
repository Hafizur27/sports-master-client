          ...
          <table className="table table-xs">
            <thead>
              <tr>
                ...
                <th>Trainer</th>
                <th>Email</th>
                <th className="flex items-center">price <BiDollar className="text-sm "></BiDollar></th>
                <th>Action</th>
                <th>Payment</th>
              </tr>
            </thead>
            <tbody>
              {allClass?.map((singleClass, index) => (
                <tr key={singleClass._id}>
                  ...
                  <td className="flex items-center mt-3 justify-center">{singleClass.price}<BiDollar className="text-yellow-500"></BiDollar></td>
                  <td>
                    <button
